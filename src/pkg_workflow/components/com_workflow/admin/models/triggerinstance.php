 ...
 * @since       1.0
 */
class WorkflowModelTriggerinstance extends JModelAdmin
{
	/**
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Triggerinstance', $prefix = 'WorkflowTable', $config = array())
	{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id)) {
			...
			if (empty($table->ordering)) {
				...
				$query->from('#__wf_trigger_instances');
