 ...
 * @since       1.0
 */
class WorkflowModelRoles extends JModelList
{
	/**
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.title, a.alias, a.checked_out, a.checked_out_time, a.method, a.note, ' .
				'a.published, a.access, a.created, a.ordering, a.language'
			)
		);
		$query->from('#__wf_user_roles AS a');
