 ...
 * @since       1.0
 */
class WorkflowViewWorkflow extends JViewLegacy
{
	/**
	...
	/**
	 * Prepare and display the Workflow view.
	 *
	 * @return  void
	 * @since   1.0
	 */
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(
			JText::_(
				...
				($checkedOut
					? 'VIEW_WORKFLOW'
					: ($isNew ? 'ADD_WORKFLOW' : 'EDIT_WORKFLOW')).'_TITLE'
			)
		);
		...
		if (!$checkedOut && $canDo->get('core.edit')) {
			...
			JToolBarHelper::custom('workflow.save2new', 'save-new.png', null, 'JTOOLBAR_SAVE_AND_NEW', false);
		}

		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::custom('workflow.save2copy', 'save-copy.png', null, 'JTOOLBAR_SAVE_AS_COPY', false);
		}
