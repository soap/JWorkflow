...
<script type="text/javascript">
	...
	{
		var form = document.id('role-form');
		if (task == 'role.cancel' || document.formvalidator.isValid(form)) {
...
<form action="<?php echo JRoute::_('index.php?option=com_workflow&layout=edit&id='.(int) $this->item->id); ?>"
	method="post" name="adminForm" id="role-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<?php echo $this->form->getLabel('method_params'); ?>
			<div class="clr"></div>
			<?php echo $this->form->getInput('method_params'); ?>
	...
	<div class="width-40 fltrt">
		<?php echo JHtml::_('sliders.start','role-sliders-'.$this->item->id, array('useCookie' => 1)); ?>
