...
?>
<form action="<?php echo JRoute::_('index.php?option=com_workflow&view=states');?>" method="post" name="adminForm">
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search"
				...
				title="<?php echo JText::_('COM_WORKFLOW_STATES_FILTER_SEARCH_DESC'); ?>" />
				...
				<td class="order">
					<?php if ($canChange) : ?>
						<span><?php echo $this->pagination->orderUpIcon($i,
							...
							'states.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ?></span>
						<span><?php echo $this->pagination->orderDownIcon($i,
							$this->pagination->total,
							($item->workflow_id == @$this->items[$i+1]->workflow_id),
							'states.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
