...
class trgGuardRequireditems extends trgAbstractTrigger 
{
    ...
    {
        $detailTable = $this->params->get('detail_table');
    	return JText::sprintf('TRG_GUARD_REQUIREDITEMS_GUARD_ITEM_MUST_HAVE_DETAIL', $detailTable );
    }
    
    public function getExplain() 
    {
        $detailTable = $this->params->get('detail_table');
    	return JText::_('TRG_GUARD_REQUIREDITEMS_GUARD_ITEM_MUST_HAVE_DETAIL', $detailTable  );
    }
